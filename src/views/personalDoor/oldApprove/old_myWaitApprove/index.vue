<template>
  <div class="app-container filter-container">
    ...
    >
      ...
      <el-table-column label="审批人" prop="stepApproveUserName" align="center"></el-table-column>
      courseName
      ...
      <el-table-column label="审批时间" prop="approvecreatedate" align="center"></el-table-column>
...
<script type="text/ecmascript-6">
  ...
  import {InitOldWaitList,repeal} from '@/api/approve'
  ...
  export default {
    ...
    methods: {
      ...
      handleSeek(row) {
        this.$router.push({name:'oldsee',query: {u_id: row.approveid,pageNum:this.listQuery.pageNum, formName:'old_waitApprove'}})
      },
      HandleWorkFlow(row){
        this.$router.push({name:'oldworkflow',query: {u_id: row.approvestepid,pageNum:this.listQuery.pageNum, formName:'old_waitApprove'}})
      },
      handleEdit(row) {
        this.$router.push({name:'oldflowInfo',
          query: {
            u_id: row.approveid,
            approveStepId:row.approvestepid,
            pageNum:this.listQuery.pageNum,
            formName:'old_waitApprove',
          }
        })
      },
    }
