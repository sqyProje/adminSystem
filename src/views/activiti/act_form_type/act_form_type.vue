        ...
        <el-table-column label="操作" fixed="right"  width="260">
          <template slot-scope="scope">
            <el-button
              size="mini"
              type="success"
              v-if="hasPerm('act_type:edit')"
              @click="handleEdit(scope.row)">编辑</el-button>
            <el-button
              size="mini"
              type="danger"
              v-if="hasPerm('act_type:deletes')"
...
<script type="text/ecmascript-6">
  ...
  import {dictionType,AddInfo,GetInfo,EditInfo,DeleteInfo} from '@/api/basic'
  ...
  export default {
    data(){
      return {
        ...
        dataType:'0556e14a6dbc49a1bb668421ad570560'
      }
    } ,
    created(){
      this.initTable();
    ...
    methods: {
      ...
      initTable() {
        ...
        dictionType(this.dataType).then(response => {
      ...
      handleAdd(){
        ...
        this.AddEditInfo.parentid = this.dataType
      },
      handleEdit(row) {
        this.dialogTitle = '编辑'
        this.dialogVisible = !this.dialogVisible
